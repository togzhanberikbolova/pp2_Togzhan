...
background = pygame.image.load("download/track.png")

screen=pygame.display.set_mode((w, h))
screen.fill(white)
pygame.display.set_caption("racer car game")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("download/coin.png")
        self.rect = self.image.get_rect()
...
class Coin2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("download/coin1.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(30, w - 30), 0)
...
class Coin3(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("download/coin2.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(30, w - 30), 0)
